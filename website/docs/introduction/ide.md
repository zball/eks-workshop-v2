...
Click on **Environments**, then select **Shared with me** in the drop-down. There should be a Cloud9 environment available **eks-workshop-cluster**, which can be launched using the **Open** button.
